...
ActiveRecord::Schema.define(version: 2021_01_12_063137) do
  ...
  create_table "content", force: :cascade do |t|
    ...
    t.datetime "updated_at", precision: 6, null: false
    t.bigint "contest_id"
    t.index ["contest_id"], name: "index_content_on_contest_id"
  end
  ...
  create_table "posts", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["teams_user_id"], name: "index_posts_on_teams_user_id"
  end
